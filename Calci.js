...
input.setAttribute(
  "style",
  `line-height:60px; background-color: yellow; font-family: 'Comfortaa', cursive;`
);
input.id = "display";
...
function createButton(txt, val, fn) {
  ...
  a.setAttribute(
    "class",
    "btn-fluid btn-lite text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2"
  );
